function createTopShoesChart() {
    ...
    fetch(`/api/shoes/top-sales?startDate=${startDate.toISOString()}&endDate=${endDate.toISOString()}`)
        ...
        .then(data => {
            const margin = {top: 120, right: 20, bottom: 120, left: 50};
            ...
            function renderChart() {
                ...
                d3.select("#top-shoes-chart").selectAll("*").remove();
...
function createChart(data) {
    ...
    d3.select("#gender-sales-chart").selectAll("*").remove();
    ...
    svg.append("text")
        ...
        .text("Sales by Gender for the Last Quarter");
...
$(document).ready(function() {
    ...
    // קריאה ראשונית לגרפים בטעינת הדף
    createTopShoesChart();
    createGenderSalesChart();
});